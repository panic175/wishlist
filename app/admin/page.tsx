...
import { wishlistsApi, itemsApi, settingsApi, versionApi, type Wishlist, type Settings, type AppVersion } from '@/lib/api';
...
export default function AdminPage() {
  ...
  useEffect(() => {
    ...
    versionApi
      ...
      .then(setVersionInfo)
      .catch(() => {
        // Version badge is cosmetic; hide it if we cannot resolve it.
      });
  }, []);
      ...
      <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        {versionInfo?.version && (
          <div className="text-center pb-2">
            <p className="inline-flex items-center gap-1.5 text-xs text-gray-400 dark:text-gray-600">
              <svg
              ...
              {t('admin.version')} {versionInfo.version}
